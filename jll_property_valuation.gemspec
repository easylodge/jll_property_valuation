...
Gem::Specification.new do |spec|
  spec.name          = "jll_property_valuation"
  spec.version       = JllPropertyValuation::VERSION
  spec.authors       = ["SeanBClark"]
  spec.email         = ["sean.bradley.clark@gmail.com"]

  spec.summary       = %q{JLL Property Valuation}
  spec.description   = %q{Interfaces with JLL's Property Valuation API}
